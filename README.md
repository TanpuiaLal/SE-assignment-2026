...
Modules: Software Process, Requirements, Design
Features:
Add/edit/delete tasks
Deadlines + reminders
Mark as completed
Bonus: Add simple UI + validation
...
1. Open Terminal
2. Navigate to the project eg: "cd C://Projects/StudentTaskApp/"
3. Start a local web server using "python -m http.server 8000"
4. Open your browser and visit "http://localhost:8000"

The application should now load and be installable as a PWA
